...
pub fn write_bool<W: Write>(val: &bool, writer: &mut W) -> Result<(), Error> {
    if *val {
...
pub fn write_varlong<W: Write>(val: &i64, writer: &mut W) -> Result<(), Error> {
    let msb: u8 = 0b10000000;
...
pub fn write_f32<W: Write>(val: &f32, writer: &mut W) -> Result<(), Error> {
    Ok(writer.write_f32::<BigEndian>(*val)?)
}

/// Write a single f64 to the Writer
pub fn write_f64<W: Write>(val: &f64, writer: &mut W) -> Result<(), Error> {
    Ok(writer.write_f64::<BigEndian>(*val)?)
}

/// Write a String to the Writer, ensuring to properly length-prefix it
#[allow(non_snake_case)]
pub fn write_String<W: Write>(val: &str, writer: &mut W) -> Result<(), Error> {
...
pub fn write_bytearray<W: Write>(val: &Vec<u8>, writer: &mut W) -> Result<(), Error> {
    Ok(writer.write_all(val)?)
}
...
pub fn write_uuid_str<W: Write>(val: &u128, writer: &mut W) -> Result<(), Error> {
    /* The string length */
    writer.write_all(&[32])?;
