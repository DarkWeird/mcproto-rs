...
use serde_mcproto::types::array::{BytePrefix, IntPrefix, ShortPrefix, VarIntPrefix};
...
pub enum LoginToClient {
    ...
    EncryptionRequest {
        server_id: String,
        pubkey: ShortPrefix<u8>,
        verify_token: ShortPrefix<u8>,
    },
    LoginSuccess {
        uuid: Uuid,
        username: String,
